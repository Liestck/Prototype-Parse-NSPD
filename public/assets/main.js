...
fetchBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    const layerCheckboxMap = {
      "kad_scheme": 36048, // КАДАСТРОВАЯ СЕТКА
      "structures": 36049, // Здания
      "gos_structures": 36328, // Гос-сооружения
      "building_structures": 36329, // Строющиеся здания
      "zoyts": 37578, // ЗОУИТЫ
      "OKN": 	37577, // Объекты культурного наследия
      "naturalAreas": 37580, // Природные зоны
      "secureObjects": 	37579, // Охраняемые объекты и безопастность
      "others": 37581, // Остальные зоны
      "secureNaturalObjects": 36317, // Охранные природные зоны
      "huntingGrounds": 36311, // Охотничьи угодья
      "forestry": 36314, // Лесничество
      "coastlines": 36470 // Береговые линии
    };

    const layers = [
      36048, // КАДАСТРОВАЯ СЕТКА
      36049, // Здания
      36328, // Гос-сооружения
      36329, // Строющиеся здания
      37578, // ЗОУИТЫ
      37577, // Объекты культурного наследия
      37580, // Природные зоны
      37579, // Охраняемые объекты и безопасность
      37581, // Остальные зоны
      36317, // Охранные природные зоны
      36311, // Охотничьи угодья
      36314, // Лесничество
      36470  // Береговые линии
    ];
